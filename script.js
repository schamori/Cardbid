...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const mobileGamesList = document.getElementById('mobileGamesList');

  console.log('Mobile menu elements:');
  console.log('  Toggle button:', mobileMenuToggle);
  console.log('  Drawer:', mobileMenuDrawer);
  console.log('  Close button:', mobileMenuClose);
  console.log('  Overlay:', mobileMenuOverlay);
  console.log('  Games toggle:', mobileGamesToggle);
  console.log('  Games list:', mobileGamesList);
  ...
  if (mobileMenuOverlay) {
    ...
    console.log('✓ Mobile menu overlay listener added');
  }

  // Toggle games dropdown in mobile menu
  if (mobileGamesToggle && mobileGamesList) {
    mobileGamesToggle.addEventListener('click', () => {
      console.log('Toggling mobile games list...');
      mobileGamesToggle.classList.toggle('active');
      mobileGamesList.classList.toggle('active');
    });
    console.log('✓ Mobile games toggle listener added');
  }

  // Close mobile menu when clicking on a link (for better UX)
  const mobileMenuLinks = mobileMenuDrawer.querySelectorAll('.mobile-game-link, .mobile-menu-link');
  mobileMenuLinks.forEach(link => {
    link.addEventListener('click', closeMobileMenu);
  });
  console.log(`✓ Added close listeners to ${mobileMenuLinks.length} mobile menu links`);
